...
pub enum lcb_CALLBACKTYPE {
    ...
    LCB_CALLBACK_DIAG = 22,
    LCB_CALLBACK__MAX = 23,
}
...
fn bindgen_test_layout_lcb_CMDPING() {
    assert_eq!(::std::mem::size_of::<lcb_CMDPING>() , 80usize , concat ! (
    ...
    assert_eq! (unsafe {
                ...
                stringify ! ( options ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_CMDPING ) ) . id as * const _ as
                usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_CMDPING ) , "::" ,
                stringify ! ( id ) ));
}
...
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum lcb_PINGSTATUS {
    LCB_PINGSTATUS_OK = 0,
    LCB_PINGSTATUS_TIMEOUT = 1,
    LCB_PINGSTATUS_ERROR = 2,
    LCB_PINGSTATUS__MAX = 3,
}
#[repr(C)]
#[derive(Debug, Copy)]
pub struct lcb_PINGSVC {
    ...
    pub latency: lcb_U64,
    pub rc: lcb_error_t,
    pub local: *const ::std::os::raw::c_char,
    pub id: *const ::std::os::raw::c_char,
    pub scope: *const ::std::os::raw::c_char,
    pub status: lcb_PINGSTATUS,
}
#[test]
fn bindgen_test_layout_lcb_PINGSVC() {
    assert_eq!(::std::mem::size_of::<lcb_PINGSVC>() , 64usize , concat ! (
    ...
    assert_eq! (unsafe {
                ...
                stringify ! ( latency ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_PINGSVC ) ) . rc as * const _ as
                usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_PINGSVC ) , "::" ,
                stringify ! ( rc ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_PINGSVC ) ) . local as * const _ as
                usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_PINGSVC ) , "::" ,
                stringify ! ( local ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_PINGSVC ) ) . id as * const _ as
                usize } , 40usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_PINGSVC ) , "::" ,
                stringify ! ( id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_PINGSVC ) ) . scope as * const _ as
                usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_PINGSVC ) , "::" ,
                stringify ! ( scope ) ));
    assert_eq! (unsafe {
...
#[test]
fn bindgen_test_layout_lcb_CMDDIAG() {
    assert_eq!(::std::mem::size_of::<lcb_CMDDIAG>() , 80usize , concat ! (
               "Size of: " , stringify ! ( lcb_CMDDIAG ) ));
    assert_eq! (::std::mem::align_of::<lcb_CMDDIAG>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( lcb_CMDDIAG ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_CMDDIAG ) ) . cmdflags as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_CMDDIAG ) , "::" ,
                stringify ! ( cmdflags ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_CMDDIAG ) ) . exptime as * const _ as
                usize } , 4usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_CMDDIAG ) , "::" ,
                stringify ! ( exptime ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_CMDDIAG ) ) . cas as * const _ as
                usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_CMDDIAG ) , "::" ,
                stringify ! ( cas ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_CMDDIAG ) ) . key as * const _ as
                usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_CMDDIAG ) , "::" ,
                stringify ! ( key ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_CMDDIAG ) ) . _hashkey as * const _
                as usize } , 40usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_CMDDIAG ) , "::" ,
                stringify ! ( _hashkey ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_CMDDIAG ) ) . options as * const _ as
                usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_CMDDIAG ) , "::" ,
                stringify ! ( options ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_CMDDIAG ) ) . id as * const _ as
                usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_CMDDIAG ) , "::" ,
                stringify ! ( id ) ));
}
impl Clone for lcb_CMDDIAG {
    fn clone(&self) -> Self { *self }
}
#[repr(C)]
#[derive(Debug, Copy)]
pub struct lcb_RESPDIAG {
    pub cookie: *mut ::std::os::raw::c_void,
    pub key: *const ::std::os::raw::c_void,
    pub nkey: lcb_SIZE,
    pub cas: lcb_CAS,
...
#[test]
fn bindgen_test_layout_lcb_RESPDIAG() {
    assert_eq!(::std::mem::size_of::<lcb_RESPDIAG>() , 56usize , concat ! (
               "Size of: " , stringify ! ( lcb_RESPDIAG ) ));
    assert_eq! (::std::mem::align_of::<lcb_RESPDIAG>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( lcb_RESPDIAG ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_RESPDIAG ) ) . cookie as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_RESPDIAG ) , "::" ,
                stringify ! ( cookie ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_RESPDIAG ) ) . key as * const _ as
                usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_RESPDIAG ) , "::" ,
                stringify ! ( key ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_RESPDIAG ) ) . nkey as * const _ as
                usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_RESPDIAG ) , "::" ,
                stringify ! ( nkey ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_RESPDIAG ) ) . cas as * const _ as
                usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_RESPDIAG ) , "::" ,
                stringify ! ( cas ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_RESPDIAG ) ) . rc as * const _ as
                usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_RESPDIAG ) , "::" ,
                stringify ! ( rc ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_RESPDIAG ) ) . version as * const _
                as usize } , 36usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_RESPDIAG ) , "::" ,
                stringify ! ( version ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_RESPDIAG ) ) . rflags as * const _ as
                usize } , 38usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_RESPDIAG ) , "::" ,
                stringify ! ( rflags ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_RESPDIAG ) ) . njson as * const _ as
                usize } , 40usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_RESPDIAG ) , "::" ,
                stringify ! ( njson ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const lcb_RESPDIAG ) ) . json as * const _ as
                usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( lcb_RESPDIAG ) , "::" ,
                stringify ! ( json ) ));
}
impl Clone for lcb_RESPDIAG {
    fn clone(&self) -> Self { *self }
}
extern "C" {
    pub fn lcb_diag(instance: lcb_t, cookie: *const ::std::os::raw::c_void,
                    cmd: *const lcb_CMDDIAG) -> lcb_error_t;
}
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
