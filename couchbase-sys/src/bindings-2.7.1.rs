...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct hostlist_st {
    _unused: [u8; 0],
}
extern "C" {
    pub fn lcb_dnssrv_query(arg1: *const ::std::os::raw::c_char,
                            arg2: *mut hostlist_st) -> lcb_error_t;
}
extern "C" {
    pub fn lcb_dnssrv_getbslist(arg1: *const ::std::os::raw::c_char,
                                arg2: ::std::os::raw::c_int,
                                arg3: *mut lcb_error_t) -> *mut hostlist_st;
}
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
