...
pub const LCB_VERSION_STRING: &'static [u8; 6usize] = b"2.7.4\x00";
pub const LCB_VERSION: ::std::os::raw::c_uint = 132868;
pub const LCB_VERSION_CHANGESET: &'static [u8; 41usize] =
    b"502c6716b24581a258fcb8920532a20a53e81d6b\x00";
...
pub const LCB_SDSPEC_F_MKDOCUMENT: ::std::os::raw::c_uint = 131072;
...
pub const LCB_CNTL__MAX: ::std::os::raw::c_uint = 69;
...
pub struct lcb_st([u8; 0]);
pub type lcb_t = *mut lcb_st;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct lcb_http_request_st([u8; 0]);
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ringbuffer_st([u8; 0]);
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct lcb_connection_st([u8; 0]);
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct lcbio_SOCKET([u8; 0]);
#[repr(C)]
#[derive(Debug, Copy)]
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct lcb_AUTHENTICATOR_Cdummy([u8; 0]);
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct lcb_histogram_st([u8; 0]);
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct lcb_N1QLPARAMS_st([u8; 0]);
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct lcbview_REQUEST_st([u8; 0]);
